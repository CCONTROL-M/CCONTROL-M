"""Script para testar se os schemas criados funcionam corretamente."""
import uuid
...
def test_categoria_schema():
    ...
    print(f"CategoriaCreate válido: {categoria_create.dict()}")
    ...
    # Verificar se os dados são válidos
    print(f"Categoria válida: {categoria.dict()}")
    ...
    # Verificar se os dados são válidos
    print(f"CategoriaUpdate válido: {categoria_update.dict()}")
...
def test_centro_custo_schema():
    ...
    # Verificar se os dados são válidos
    print(f"CentroCustoCreate válido: {centro_custo_create.dict()}")
    ...
    # Verificar se os dados são válidos
    print(f"CentroCusto válido: {centro_custo.dict()}")
...
def test_cliente_schema():
    ...
    # Verificar se os dados são válidos
    print(f"ClienteCreate válido: {cliente_create.dict()}")
    ...
    # Verificar se os dados são válidos
    print(f"Cliente válido: {cliente.dict()}")
...
def test_fornecedor_schema():
    ...
    # Verificar se os dados são válidos
    print(f"FornecedorCreate válido: {fornecedor_create.dict()}")
    ...
    # Verificar se os dados são válidos
    print(f"Fornecedor válido: {fornecedor.dict()}")
...
def test_log_sistema_schema():
    ...
    # Verificar se os dados são válidos
    print(f"LogSistemaCreate válido: {log_create.dict()}")
    ...
    # Verificar se os dados são válidos
    print(f"LogSistema válido: {log.dict()}")
